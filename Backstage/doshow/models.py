...
class PresentPropTbl(models.Model):                 #虚拟物交易记录表
...
class DwMoneyFlow(models.Model):                #用户充值消费记录表
    consume_type = models.IntegerField()        # 1 充值  2 消费  3 兑换
    ...
    mark = models.CharField(max_length=200, blank=True, null=True)  # 注明“购买聊天室、蓝钻会员之类的信息”
    create_time = models.DateTimeField()
